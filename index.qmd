...
df_pairwise_total |> 
  ...
  hclust() |> 
  as.phylo() %>% 
  plot(main = "Clusterization with the common of stimuli",
       tip.color = colors$color[match(.$tip.label, colors$language)],
       direction = "downwards",
       cex = 1.5,
       font = 2)
...
et |> 
  ...
  hclust() |> 
  as.phylo()  %>%
  plot(main = "Verb etimology with common stimuli",
       tip.color = colors$color[match(.$tip.label, colors$language)],
       direction = "downwards",
       cex = 1.5, 
       font = 2)
...
et |> 
  ...
  hclust() |> 
  as.phylo()  %>%
  plot(main = "Adposition etimology, common stimuli",
       tip.color = colors$color[match(.$tip.label, colors$language)],
       direction = "downwards",
       cex = 1.5, 
       font = 2)
...
complex_verbs |> 
  ...
  na.omit() |> 
  arrange(form, number) |> 
  mutate(id = str_c(number, "_", form),
         language = str_c(language, "_", n_parts)) |> 
