...
et |> 
  ...
  hclust() |> 
  as.phylo()  %>%
  plot(main = "Verb etymology with random equivalents",
       tip.color = colors$color[match(.$tip.label, colors$language)],
       direction = "downwards",
       cex = 1.5, 
       font = 2)
...
etym_random  |> 
  neighborNet() |> 
  plot()
title(main = "Verb etymology with random equivalents")
```
...
et |> 
  ...
  hclust() |> 
  as.phylo()  %>%
  plot(main = "Adposition etymology, common stimuli",
       tip.color = colors$color[match(.$tip.label, colors$language)],
       direction = "downwards",
       cex = 1.5, 
       font = 2)
...
complex_verbs |> 
  ...
  hclust() |> 
  as.phylo()  %>%
  plot(main = "Complex verbs semantics with random stimuli",
       tip.color = colors$color[match(.$tip.label, colors$language)],
       direction = "downwards",
       cex = 1.5, 
       font = 2)
