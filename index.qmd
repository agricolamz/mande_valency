...
colors <- tibble(language = c("Guro", "Dan Gweetaa", "Dan_Gweetaa", "Mano", 
       ...
       color = c("gold1", "gold3", "gold3","gold3", "cyan3", "cyan3", "cyan1", "dodgerblue4"))
```
...
df_pairwise_total |> 
  ...
  hclust() |> 
  as.phylo() %>% 
  plot(main = "Clusterization with the sample of stimuli",
       tip.color = colors$color[match(.$tip.label, colors$language)],
       direction = "downwards",
       cex = 1.5,
       font = 2)
...
et |> 
  ...
  hclust() |> 
  as.phylo()  %>%
  plot(main = "Verb etimology with the sample of stimuli",
       tip.color = colors$color[match(.$tip.label, colors$language)],
       direction = "downwards",
       cex = 1.5, 
       font = 2)
